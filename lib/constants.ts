export const SITE_NAME = "Obinwanne Farms";
export const SITE_DESCRIPTION =
  "Premium farm produce, seedlings, and digital guides — straight from the farm to you.";

export const COOKIE_TOKEN = "obin_token";
export const COOKIE_ROLE = "obin_role";

export const API_URL =
  process.env.NEXT_PUBLIC_API_URL ?? "http://localhost:6600/api/v1";
